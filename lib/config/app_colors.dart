...
class AppColors {
  ...
  static const Color cardBackground =
      Color(0xFF252B3B); // Cards un poco más claras
  ...
  static const Color oficial = Color(0xFFF59E0B); // Ámbar (preguntas oficiales)
  static const Color puntuacion = Color(0xFF3B82F6); // Azul para puntuación

  // Explicaciones
  static const Color explicacionBackground =
      Color(0xFF1E3A5F); // Azul oscuro para explicaciones
